...
$result = mysqli_query($mainDBConn, "SELECT name, pic FROM groups WHERE gid='$gid'");
		...
		<script type="text/javascript">
			...
			function sendMessage() {
				...
				if ($('#messageInput').val() == "") {
					...
					$.post("sendMessage.php", {id:<?php echo $_SESSION['id']; ?>,gid:<?php echo $_GET['gid']; ?>,message:$('#messageInput').val()}, function(data) {
						console.log(data);
						if (data == 1) {
			...
			function updateMessages() {
				...
				$.post("getMessage.php",{id:<?php echo $_SESSION['id']; ?>,gid:<?php echo $_GET['gid']; ?>,target:"all"}, function(data) {
					window.vara = JSON.parse(data);
				}); // GET ALL MESSAGES

				$.post("getMessage.php",{id:<?php echo $_SESSION['id']; ?>,gid:<?php echo $_GET['gid']; ?>,target:"id"}, function(data) {
		...
		<div id="container">
			...
			<div id="box">
				<div id="messageHeader">
					<img src="<?php echo $gPic; ?>" id="messageHeaderImage">
					<div id="messageHeaderText"><b><?php echo $gName; ?></b></div>
				</div>
				<div id="messageBox">
				</div>
